...
/// Replaces the duplicate TextFieldView, ToggleView, SliderView, PickerView wrappers.
///
/// This wrapper:
...
struct StatefulTextField: View {
    ...
    init(placeholder: String, initialText: String, styles: ViewNode.TextFieldStyles?, nodeId: String, onEvent: @escaping (String, String) -> Void) {
...
struct StatefulToggle: View {
    ...
    init(label: String, isOn: Bool, styles: ViewNode.ToggleStyles?, nodeId: String, onEvent: @escaping (String, String) -> Void) {
        self.label = label
...
struct StatefulToggleWithContent<Content: View>: View {
    ...
    init(isOn: Bool, styles: ViewNode.ToggleStyles?, nodeId: String, onEvent: @escaping (String, String) -> Void, @ViewBuilder content: @escaping () -> Content) {
        self.initialValue = isOn
        self.styles = styles
        self.nodeId = nodeId
        self.onEvent = onEvent
...
struct StatefulSlider: View {
    ...
    init(value: Double, range: ClosedRange<Double>, step: Double?, styles: ViewNode.SliderStyles?, nodeId: String, onEvent: @escaping (String, String) -> Void) {
...
struct StatefulPicker: View {
    ...
    init(label: String, selection: String, options: [ViewNode.PickerOption], styles: ViewNode.PickerStyles?, nodeId: String, onEvent: @escaping (String, String) -> Void) {
        self.label = label
...
struct StatefulDisclosureGroup<Content: View>: View {
    ...
    init(label: String, isExpanded: Bool, nodeId: String, onEvent: @escaping (String, String) -> Void, @ViewBuilder content: @escaping () -> Content) {
        self.label = label
...
enum StatefulControls {
    ...
    static func textField(
        ...
        StatefulTextField(placeholder: placeholder, initialText: initialText, styles: styles, nodeId: nodeId, onEvent: onEvent)
    }
    ...
    static func secureField(
        ...
        StatefulSecureField(placeholder: placeholder, initialText: initialText, styles: styles, nodeId: nodeId, onEvent: onEvent)
    }
    ...
    static func slider(
        ...
        StatefulSlider(value: value, range: range, step: step, styles: styles, nodeId: nodeId, onEvent: onEvent)
    }
    ...
    static func picker(
        ...
        StatefulPicker(label: label, selection: selection, options: options, styles: styles, nodeId: nodeId, onEvent: onEvent)
    }
}
