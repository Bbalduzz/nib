"""AttributedString Demo - Rich text with multiple styles.

This example demonstrates how to create rich text with different styles
for different parts of the text using nib.AttributedString.
"""
