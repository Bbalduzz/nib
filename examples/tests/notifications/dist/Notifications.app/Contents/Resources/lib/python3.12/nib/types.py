...
def resolve_enum(value) -> Optional[str]:
    ...
    Returns:
        The string value of the enum, or the string itself, or None

    Examples:
        resolve_enum(ButtonStyle.BORDERED)  # Returns "bordered"
        resolve_enum("bordered")            # Returns "bordered"
        resolve_enum(None)                  # Returns None
    """
    if value is None:
        return None
...
def resolve_color(color: ColorLike) -> str:
    """Convert a color-like value to a string."""
